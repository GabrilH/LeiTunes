...
//	}
	...
	@Test
	void testMatches() {
		SongMetaInfo smi = new SongMetaInfo("Title",  Arrays.asList("Author 1", "Author 2"), "Genre", "Album");
	...
	@Test
	void testToString() {
		SongMetaInfo smi = new SongMetaInfo("Song Title",  Arrays.asList("Author 1", "Author 2"), "Genre", "Album");
