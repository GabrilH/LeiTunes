...
public class EvalManualPlaylistTest {
	...
	public void setUp() throws Exception {
		...
		SongMetaInfo info3 = new SongMetaInfo("Test song 3",  Arrays.asList("Test artist3"), "Hip Hop", "Test album3");
		// Create a Song
		song3 = new Song(info3, "test_song.mp3");
		lib.add(song1);
		lib.add(song2);
		lib.add(song3);
	...
	public void testMoveSelected() {
		...
		playlist.add(song2);
		playlist.select(0);
		// CORRECTION: the test does not comply with the contract of moveUpSelected,
		// it is moving DOWN the selected song. 
	...
	public void testGetSelected() {
		...
		playlist.add(song2);
		playlist.add(song3);
		// CORRECTION: by the given Playlist interface, add() should select the added song
