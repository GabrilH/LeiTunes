...
public class EvalMostRecentlyAddedSongsPlaylistTest {
	  ...
	  private MusicLibrary library;
		...
		public void setUp() {
			...
			SongMetaInfo info = new SongMetaInfo("Title",  Arrays.asList("Author 1", "Author 2"), "Genre", "Album");
			// Create a Song
			song = new Song(info, "test_song.mp3");
			song.incTimesPlayed();
		...
		public void testProcessEventSongRated() {
			SongRatedLibraryEvent event = null;
			 try {
		            Constructor<SongRatedLibraryEvent> constructor = SongRatedLibraryEvent.class.getDeclaredConstructor(ISong.class,MusicLibrary.class);
